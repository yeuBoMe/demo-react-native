                    ...
                    >
                        ...
                        >
                                ...
                                >
                                    <View style={styles.bannerTextContainer}>
                                        <View style={{ flexDirection: "row", marginBottom: 6 }}>
                                            ...
                                            <Text style={styles.textUser}>{user ? user.name : "Khách"}</Text>
                                        </View>
                                        <Text style={styles.bannerText}>
                                            Thưởng thức gelato{"\n"}như không có{"\n"}ngày mai!
                                        </Text>
                            ...
                            >
                                ...
                                >
                                    <View style={styles.bannerTextContainer}>
                                        <Text style={styles.banner2Discount}>Giảm giá 50</Text>
                                        <Text style={styles.banner2Title}>50%</Text>
                                        <Text style={styles.banner2Subtitle}>Tất cả món Á</Text>
                                    </View>
                                    <View style={styles.freeDeliveryBadge}>
                                        <Text style={styles.freeDeliveryText}>Giao hàng miễn phí</Text>
                                    </View>
                                </ImageBackground>
                            </TouchableOpacity>
                        </ScrollView>
